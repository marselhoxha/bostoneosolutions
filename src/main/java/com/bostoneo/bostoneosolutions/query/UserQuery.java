...
public class UserQuery {
    ...
    public static final String DELETE_PASSWORD_VERIFICATION_BY_USER_ID = "DELETE FROM ResetPasswordVerifications WHERE user_id = :userId";
    ...
    public static final String SELECT_USER_BY_URL_QUERY = "SELECT * FROM Users WHERE id = (SELECT user_id FROM ResetPasswordVerifications WHERE url = :url)";
